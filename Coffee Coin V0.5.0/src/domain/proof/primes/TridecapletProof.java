...
// by the chain before
//
public class TridecapletProof extends KConstellationProof  {
	private static final long serialVersionUID = -8337541918409524143L;

	public TridecapletProof(Object[] primes, Asset asset) throws NoSuchAlgorithmException, IOException {
		super(primes, asset);
	}
	...
	protected BigInteger getkConstellationValue() {
		return Settings.instance().getTridecapletValue();
	}
}
